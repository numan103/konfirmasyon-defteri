...
(async () => {
  ...
  const marks = {
    APP_BUILD_b59: html.includes("APP_BUILD = 'b59'"),
    ...
    alfa_portfoy_modern_ui: html.includes('ap2-sum-card') && html.includes('ap2-card') && html.includes('ap2-alloc'),
  };
  let ok = true;

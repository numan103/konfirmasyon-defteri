...
(async () => {
  ...
  const marks = {
    ...
    ap2_deposit: html.includes('#ap2-deposit') && html.includes('id="ap2-deposit-amount"') && html.includes('function ap2Deposit'),
    ...
    sosyalmetre_checklist: html.includes('sm-cond-list') && html.includes('smCondAdd') && html.includes('smCondDel') && html.includes('smCondMove'),
    sosyalmetre_trades: html.includes('sm-trade-list') && html.includes('smTradeAdd') && html.includes('smTick') && html.includes('smEval'),
    sosyalmetre_share: html.includes('sm-share-card') && html.includes('smShare') && html.includes('smCopy') && html.includes('smPng') && html.includes('toDataURL'),

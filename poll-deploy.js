...
const KEYS = ['sosyalmetre_page', 'sosyalmetre_route', 'sosyalmetre_tabs', 'sosyalmetre_checklist', 'sosyalmetre_trades', 'sosyalmetre_bands', 'sosyalmetre_share', 'sosyalmetre_edit', 'sosyalmetre_img', 'sosyalmetre_save', 'sosyalmetre_old_removed', 'ap2_sellmeta', 'ap2_deposit', 'ap2_pricefix', 'alfa_portfoy_tg_endpoint', 'alfa_portfoy_tg_pnl_events', 'ap2_modern_form', 'ap2_growth_row', 'ap2_donut_gaps', 'ap2_sym_chips', 'butce_cleanhead', 'butce_rename', 'sosyalmetre_private', 'sosyalmetre_rules', 'sosyalmetre_catedit', 'alfa_portfoy_hedge', 'alfa_portfoy_ui', 'alfa_portfoy_histrobust', 'alfa_portfoy_limit', 'uyap', 'uyap_autolink', 'uyap_notes', 'uyap_timeline', 'stats_admin', 'karne_ek', 'uyap_hide'];
for (let i = 0; i < 12; i++) {
  if (i) sleepMs(25000);
  try {
